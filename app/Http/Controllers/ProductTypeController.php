...
class ProductTypeController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($producttype->update($data)){
            return response()->json(['result' => 'Đã sửa thành công loại sản phẩm'],200);
        }else{
            return response()->json(['result' => 'Đã sửa không thành công loại sản phẩm'],200);
        }
    ...
    { 
        ...
        if($producttype->delete()){
            return response()->json(['result' => 'Đã xóa thành công loại sản phẩm'],200);
        }else{
            return response()->json(['result' => 'Đã xóa không thành công loại sản phẩm'],200);
        }
    }
}
